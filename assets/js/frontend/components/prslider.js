 ...
 */
/* eslint-disable */
export default function PodcastifyRangeSlider( target, event, vertical ) {
	...
	addClass( 'current-slide', currentSlide );
	...
	function dragInit() {
		...
		currentSlide.style[cssCS] = `${( ( cacheValue / 100 ) * rangerSize ) - ( draggerSize / 2 )  }px`;
	...
	function dragUpdate( e ) {
		...
		if ( drag ) {
			...
			currentSlide.style[cssCS] = `${move - ( draggerSize / 2 )  }px`;
